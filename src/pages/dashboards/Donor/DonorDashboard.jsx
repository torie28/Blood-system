...
const DonorDashboard = () => {
  ...
  const fetchBloodRequests = async () => {
    ...
    try {
      ...
      let endpoint = "/donor-requests?status=approved";
      if (userLocation) {
        endpoint += `&location=${encodeURIComponent(userLocation)}`;
      }
  ...
  const handleScheduleDonation = async (requestId) => {
    ...
    try {
      ...
      if (response.success) {
        alert(
          "Donation scheduled successfully! The hospital will contact you soon.",
        );
      ...
      <div className="classic-dashboard-content">
        ...
        <div className="classic-stats-grid">
          <div className="classic-stat-card">
            <div className="classic-stat-number">
              {loading ? "..." : donationStats.total_donations}
            </div>
          ...
          <div className="classic-stat-card">
            <div className="classic-stat-number">
              {loading
                ? "..."
                : (donationStats.days_since_last_donation ?? "N/A")}
            </div>
        ...
        <div className="classic-main-grid">
          ...
          <div>
            ...
            <div className="classic-card">
              ...
              <div className="classic-actions-grid">
                <button
                  className="classic-action-button profile"
                ...
                <button
                  className="classic-action-button history"
            ...
            <div className="classic-card">
              ...
              >
                <h2 className="classic-card-title" style={{ marginBottom: 0 }}>
                  Scheduled Donations
                </h2>
                <a
                  href="#"
                ...
                scheduledDonations.map((donation) => (
                  <div key={donation.id} className="classic-donation-item">
                    <div className="classic-donation-info">
                      <h4>
                        <span className="classic-hospital-icon">
                          {"\ud83c\udfe5"}
                        </span>
                        {donation.blood_request?.hospital?.name ||
                          donation.blood_request?.hospital?.hospital_name ||
                          "Hospital"}
                      </h4>
                      <p>
                        <span className="classic-date-icon">
                          {"\ud83d\udcc5"}
                        </span>
                      ...
                      >
                        <span className="classic-donor-icon">
                          {"\ud83d\udc64"}
                        </span>
                        {donation.donor?.name || user?.name || "Donor"} (
                        {donation.donor?.blood_group}
                        {donation.donor?.blood_type || user?.blood_group}
                        {user?.blood_type || ""})
                      </p>
                      <p
                        style={{
                      ...
                      >
                        <span className="classic-phone-icon">
                          {"\ud83d\udcde"}
                        </span>
                    ...
                    <div className="classic-donation-details">
                      ...
                      <div
                        className={`classic-donation-status ${donation.status}`}
                      >
          ...
          <div>
            ...
            <div className="classic-card">
              ...
              <div className="classic-profile-header">
                <img
                  src={
                    user?.profile_photo ||
                    "https://picsum.photos/seed/donor/60/60.jpg"
                  }
                  alt="Profile"
                ...
                />
                <div>
                  <h3 className="classic-profile-name">
                    {user?.name || "John Doe"}
                  </h3>
              ...
              <div className="classic-profile-info">
                ...
                <span className="classic-profile-value">
                  {user?.blood_group}
                  {user?.blood_type || "N/A"}
                </span>
              </div>
            ...
            <div className="classic-card classic-requests-card">
              <h2 className="classic-card-title">
                🩸 Blood Donation Requests{" "}
                <span className="classic-pulse-dot"></span>
              </h2>
              <p
                style={{
                  fontSize: "13px",
                    ...
                    >
                      <div className="classic-request-header">
                        ...
                        <div className="classic-request-actions">
                          <div
                            className={`classic-urgency-badge ${request.urgency_level?.name?.toLowerCase() || "pending"}`}
                          >
            ...
            <div className="classic-card">
              ...
              <div className="classic-health-tip">
                ...
                <p className="classic-health-tip-text">
              ...
              <div className="classic-health-tip">
                <div className="classic-health-tip-icon">✓</div>
                <p className="classic-health-tip-text">
                  Get at least 8 hours of sleep before your donation
                </p>
              </div>
            </div>
          </div>
            ...
            <form onSubmit={handleProfileUpdate}>
                  ...
                  <div style={{ position: "relative" }}>
                    <img
                      src={
                        photoPreview ||
                        user?.profile_photo ||
                        "https://picsum.photos/seed/donor/80/80.jpg"
                      }
                      alt="Profile Preview"
                      style={{
                        width: "80px",
              ...
              <div style={{ marginBottom: "15px" }}>
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleProfileChange("blood_group", e.target.value)
                  }
                  style={{
                    width: "100%",
                    padding: "10px",
              ...
              <div style={{ marginBottom: "20px" }}>
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleProfileChange("blood_type", e.target.value)
                  }
                  style={{
                    width: "100%",
                    padding: "10px",
          ...
          >
            ...
            {historyLoading ? (
                  ...
                  >
                    ...
                    >
                      <div>
                        ...
                        >
                          {donation.bloodRequest?.blood_group || "N/A"} blood
                          requested
                        </p>
                      </div>
              ...
              <div style={{ textAlign: "center", padding: "40px" }}>
                ...
                <p style={{ color: "#999" }}>
                  You haven't made any donations yet. Start by scheduling your
                  first donation!
                </p>
              </div>
            )}
